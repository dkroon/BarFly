...
/**
 * Uses a net.maizegenetics.barfly.DBInteract object & DBInter's methods to upload
 */
public class DBUploadGUI extends JFrame implements FocusListener {
...
//        this.setLocation(new Point(135, 51));
    ...
    private void loadButton_actionPerformed(ActionEvent e) {
        ...
        String phaser = ""; //(String) phaserIDCombo.getSelectedItem();
        ...
        processData(phaser, user, data, null);
    }
                    ...
                    if (fileAccessed) {
                        ...
                        try {
                            ...
                            if (sb == null) { //  if the StringBuffer was never initialized
                                ...
                                String msg = "File " + directoryFile[i].getName() + " could not be loaded.  " +
                                        "Please modify the file and try loading again.";
                                JOptionPane.showMessageDialog(this, msg, "File requires editting",
                                        JOptionPane.WARNING_MESSAGE);

                            } else {
                                //QQQQ used for uploading Narasim's & Jesse's raw data files
//                                processDataPrimitively(sb.toString(), directoryFile[i].getName());

                                processData(phaser, user, sb.toString(), directoryFile[i].getName());  // enter it into the db
                            }
                            in.close();
     ...
     * @param data
     */
    private void processData(String phaser, String user, String data, String fileName) {

//        System.out.println("fileName: " + fileName);
        DBInteract current = new DBInteract( );
        ...
        switch (check) {
            ...
            case 0: //attempt to write to BarFly.raw database table failed, back up data to file.
                ...
                // TODO IMPLEMENT BACKUP OF DATA TO FILE
     ...
     * @param fileName
     */
    private void processDataPrimitively(String fileContents, String fileName){
//        System.out.println("fileName: " + fileName);
        DBInteract current = new DBInteract( );
        current.insertDataPrimitively(fileContents, fileName);
